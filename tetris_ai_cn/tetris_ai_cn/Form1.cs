    ...
    public partial class Form1 : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (curbrick == null)
            {
                ...
                bricknum += 1;
                if (bricknum % 10 == 0)
                    if (bricknum <= 1000) textBox2.Text += height + Environment.NewLine;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (aichoose == 0) trackBar1.Enabled = !timer1.Enabled;
        ...
        {
            aichoose = 5;
            textBox1.Text = "切换：五号AI，将不响应用户方向键";
        }
    }
}
