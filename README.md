...
中国大陆用户建议 [转到码云查看代码](https://gitee.com/grdaimap/tetris_ai) 
...
- 2020.7.19更新：版本1.4，增加了一个自己编写的AI，其能力中等。[tetris_ai_cn-full-20.7.19.exe](./tetris_ai_cn-full-20.7.19.exe)
